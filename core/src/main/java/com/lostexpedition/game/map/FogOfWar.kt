...
class FogOfWar(
    ...
    init {
        // Încărcată dintr-un FileHandle (nu generată din Pixmap la runtime), ca LibGDX
        // s-o reîncarce automat pe Android la pierderea contextului OpenGL (background/foreground) -
        // o textură creată din Pixmap NU e "managed" și rămâne goală după un asemenea eveniment.
        gradientTexture = Texture(Gdx.files.internal("textures/fog/fog_gradient.png")).apply {

...
import com.lostexpedition.game.states.WordPuzzleState
    ...
    override fun update() {
        ...
        if (player != null && interactBounds.overlaps(player.bounds.toRectangle())) {
            ...
            if (interactPressed) {
                ...
                // Id-ul 99 este masa din nivelul 3 si deschide puzzle-ul cu litere,
                // exact ca in varianta Java desktop.
                if (puzzleId == 99) {
